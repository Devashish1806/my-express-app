...
class WelcomeDialog extends base_component_dialog_1.BaseComponentDialog {
    constructor(id) {
    ...
    step1(stepContext) {
        return __awaiter(this, void 0, void 0, function* () {
            yield stepContext.context.sendActivity("Welcome Dialog initiated.", "Welcome Dialog initiated.", botbuilder_1.InputHints.IgnoringInput);
    ...
    step2(stepContext) {
        return __awaiter(this, void 0, void 0, function* () {
            yield stepContext.context.sendActivity("Welcome Dialog end step.", "Welcome Dialog end step.", botbuilder_1.InputHints.IgnoringInput);
            return yield stepContext.endDialog("Welcome Dialog ended");
        });
    }
    getNewInstance() {
...
//# sourceMappingURL=welcome.dialog.js.map