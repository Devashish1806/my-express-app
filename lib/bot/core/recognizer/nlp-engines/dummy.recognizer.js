...
exports.DummyNlp = void 0;
const platform_enums_1 = require("../../platform.enums");
const platform_base_recognizer_1 = require("../platform.base-recognizer");
class DummyNlp extends platform_base_recognizer_1.PlatformBaseRecognizer {
    constructor(nlp) {
        super();
    }
    getNLP() {
        return platform_enums_1.NLP.DUMMY.toString();
    }
    onRecognize(context) {
...
exports.DummyNlp = DummyNlp;
//# sourceMappingURL=dummy.recognizer.js.map